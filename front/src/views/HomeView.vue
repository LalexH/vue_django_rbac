<template>
  <el-container>
    ...
    <el-affix>
      <el-aside width="auto">
        <el-menu router :collapse="is_collapsed" unique-opened>
          <el-menu-item style="height:60px;background-color: #d6e2f5" @click="this.is_collapsed = !this.is_collapsed">
    ...
    <el-container>
      <!-- 顶部 -->
      <el-header height="60px" style="line-height: 60px;background-color: #d6e2f5; width: 100%;">
        <el-row>
          <el-col :span="2" :offset="22">
            <el-button type="primary" text size="large" @click="personDrawer = true">
              <el-icon size="large"><UserFilled /></el-icon>个人中心
            </el-button>
          </el-col>
        </el-row>
      </el-header>
          ...
          <div class="grid-content bg-purple" style="margin-top: 10px; margin-left: 10px; margin-bottom: 10px;">
            <el-card class="box-card">
              ...
              <div style="margin-top: 10px;">
                ...
                <!-- 重置密码form -->
                <el-form v-if="password_visible" style="margin-top: 10px;">
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      // this.userInfo.menus.forEach(k => {
      //   k.children.forEach(j => {
      //     if(j.route_path === "/resource"){
